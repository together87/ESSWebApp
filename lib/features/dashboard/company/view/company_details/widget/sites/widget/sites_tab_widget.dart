...
class SitesTabListWidget extends StatefulWidget {
  final String title;
  const SitesTabListWidget({
    required this.title,
    super.key,
  });

  @override
  State<SitesTabListWidget> createState() => _SitesTabListState();
}

class _SitesTabListState extends State<SitesTabListWidget> with TickerProviderStateMixin {
        ...
        children: [
          TabBar(
            ...
            unselectedLabelStyle:
                textSemiBold12.copyWith(color: themeData.textColor, fontSize: 13, fontWeight: FontWeight.w600, fontFamily: 'Montserrat'),
            tabs: <Widget>[
              Tab(
                  child: Container(
                      decoration: BoxDecoration(border: Border(bottom: BorderSide(color: themeData.hintColor.withOpacity(0.5), width: 2))),
                      child: Center(child: Text('Associated ${widget.title}')))),
              Tab(
                  child: Container(
                      decoration: BoxDecoration(border: Border(bottom: BorderSide(color: themeData.hintColor.withOpacity(0.5), width: 2))),
                      child: Center(child: Text('Available ${widget.title}')))),
            ],
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Text(
                    ...
                    overflow: TextOverflow.ellipsis,
                    style:
                        sitesSubMenuTitle5.copyWith(color: themeData.textColor, fontWeight: FontWeight.w500, fontSize: 13, fontFamily: 'Montserrat'),
                  ),
                ),
              ],
            ),
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      overflow: TextOverflow.ellipsis,
                      style: sitesSubMenuTitle5.copyWith(
                          color: themeData.textColor, fontWeight: FontWeight.w500, fontSize: 13, fontFamily: 'Montserrat'),
                    ),
                  ),
                ],
              ),
