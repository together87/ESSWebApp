...
class AppTheme {
  static ThemeData themeData(bool isDarkTheme, BuildContext context) {
    ...
    return isDarkTheme ? ThemeColors.lightTheme.copyWith(extensions: [appSidebarTheme]) : ThemeColors.darkTheme.copyWith(extensions: [appSidebarTheme]);
  }
}
...
class ThemeColors {
  ...
  static final darkTheme = ThemeData(
    ...
    colorScheme: ColorScheme(
      ...
      primary: AppColors.primaryColor,
      // Customize your primary variant color
      secondary: Colors.green,
      // Customize your secondary variant color
      surface: Colors.grey.shade900,
      // Customize your surface color
      error: Colors.red,
      // Customize your error color
      onPrimary: Colors.white,
      // Customize your on-primary color
      onSecondary: Colors.white,
      // Customize your on-secondary color
      onSurface: Colors.white,
      // Customize your on-surface color
      onBackground: Colors.white,
      // Customize your on-background color
      onError: Colors.white,
      // Customize your on-error color
      brightness: Brightness.dark,
    ),
  );
...
Color get bgColor => brightness == Brightness.light ? const Color(0xfff1f4f9) : const Color(0xFF00040F);
  //
  Color get textColor => brightness == Brightness.light ? const Color(0xFF403930) : const Color(0xFFFFF8F2);
  Color get tableborderColor => brightness == Brightness.light ? Colors.grey : const Color(0xFFFFF8F2);
  //
  Color get secondaryColor => const Color(0xFFFE53BB);

  //
  Gradient get serviceCard => brightness == Brightness.light ? AppColors.grayWhite : AppColors.grayBack;

  //
  Gradient get contactCard => brightness == Brightness.light ? AppColors.grayWhite : AppColors.contactGradi;
}
